...
| [iceberg-catalog](skills/iceberg-catalog/SKILL.md) | Engine-agnostic guidance for working with oleander Iceberg catalog tables, including naming conventions, catalog hierarchy, and table reference patterns. |
